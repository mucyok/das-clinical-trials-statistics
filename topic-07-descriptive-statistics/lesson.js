...
function meanBuild(k){
 ...
 else b+=`<foreignObject x="25" y="175" width="1100" height="85"><div xmlns="http://www.w3.org/1999/xhtml" class="mean-equation">${math(expanded,true)}</div></foreignObject><foreignObject x="25" y="270" width="1100" height="120"><div xmlns="http://www.w3.org/1999/xhtml" class="mean-equation" data-reveal="mean-sigma">${math(tex`\bar{x}=\frac{1}{7}\sum_{i=1}^{7}x_i\approx4.43`,true)}</div></foreignObject>`;
 return svg(b,1152,400,'Mean of the seven observed values; the expanded indexed sum remains visible when sigma notation appears.');
}
